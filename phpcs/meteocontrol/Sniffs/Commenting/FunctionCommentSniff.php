 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Meteocontrol_Sniffs_Commenting_FunctionCommentSniff extends PEAR_Sniffs_Commenting_FunctionCommentSniff
{
        ...
        foreach ($params as $pos => $param) {
            ...
            foreach ($typeNames as $typeName) {
                ...
                if ($typeName !== $suggestedName) {
                    ...
                    } else if ($this->_phpVersion >= 50400 && strpos($suggestedName, 'callable') !== false) {
                        $suggestedTypeHint = 'callable';
                    } else if ($this->_phpVersion >= 50400 && strpos($suggestedName, 'callback') !== false) {
                        $suggestedTypeHint = 'callable';
     ...
     * @return string
     */
    private static function suggestType($varType)
    {
        return str_replace(array('integer', 'boolean'), array('int', 'bool'), PHP_CodeSniffer::suggestType($varType));
