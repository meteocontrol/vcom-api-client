...
class CommentsTest extends TestCase {
    ...
    public function testGetComments() {
        ...
        $this->assertEquals('2016-02-19T16:49:20+05:00', $comments[0]->createdAt->format(DATE_ATOM));
        ...
        $this->assertEquals('2016-02-19T16:49:07+05:00', $comments[1]->createdAt->format(DATE_ATOM));
    ...
    private function getCommentDetail2() {
        $commentDetail = new CommentDetail();
        $commentDetail->createdAt = DateTime::createFromFormat(DATE_ATOM, '2017-10-01T00:00:00+03:00');
